...
class CampaignData(BaseModel):
    ...
    selected_job_boards: List[str] = []
    bot_introduction: Optional[str] = None
    outreach_delay_mins: Optional[int] = Field(default=None, ge=-1)
    phase1_6hr_reminder_hours: Optional[float] = Field(default=None, ge=-1)
    phase1_to_phase2_hours: Optional[float] = Field(default=None, ge=-1)
    phase2_to_phase3_hours: Optional[float] = Field(default=None, ge=-1)
    phase1_6hr_call_delay_mins: Optional[int] = Field(default=None, ge=-1)
    phase2_call_delay_mins: Optional[int] = Field(default=None, ge=-1)
    phase3_call_delay_mins: Optional[int] = Field(default=None, ge=-1)
