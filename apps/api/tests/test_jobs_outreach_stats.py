...
@pytest.mark.asyncio
async def test_get_job_outreach_stats_live_api_wins(
...
@pytest.mark.asyncio
async def test_get_job_outreach_stats_fallback_wins_when_live_api_empty(
    mock_db_connection, mock_verify_job_access, mock_fetch_all_outreach, mock_get_current_user
):
    from routers.jobs import get_job_outreach_stats
...
@pytest.mark.asyncio
async def test_get_job_outreach_stats_empty_zero_buckets(
    mock_db_connection, mock_verify_job_access, mock_fetch_all_outreach, mock_get_current_user
):
    from routers.jobs import get_job_outreach_stats
