...
export function AIProvider({ children }: { children: ReactNode }) {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { role: 'assistant', content: "Hi, I'm Tira — your recruiting sidekick. Ask me about a job (e.g. \"status of 26-12345\"), or switch to Boolean, Resume match, AI check, or Report bug above." }
    ]);
